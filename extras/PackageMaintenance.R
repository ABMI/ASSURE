...
#
# This file is part of adhdAdolescent
#
...
OhdsiRTools::checkUsagePackage("adhdAdolescent")
OhdsiRTools::updateCopyrightYearFolder()
devtools::spell_check()

# Create manual -----------------------------------------------------------
unlink("extras/adhdAdolescent.pdf")
shell("R CMD Rd2pdf ./ --output=extras/adhdAdolescent.pdf")
...
OhdsiRTools::createRenvLockFile("adhdAdolescent")
